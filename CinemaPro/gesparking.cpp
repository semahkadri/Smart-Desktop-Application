...
Gesparking::Gesparking(QWidget *parent) : QWidget(parent)
{
    ...
    tempdb.ptable->setGeometry(0,10,400,400);
    ...
    QHeaderView* header = tempdb.ptable->horizontalHeader();
    header->setStretchLastSection(true);
    tempdb.ptable->setSortingEnabled(false);
    tempdb.showparkingtable();
    tempdb.ptable->setSortingEnabled(true);
